...
*
*     classes.php  Display a list of classes that
*          can be selected for registration.
*     Called by index.php and calls emailentry.php
*
********************************************************
			...
			<div id="main">
				...
				<table width="850" border="1" frame="void" rules="all" cellspacing="1" cellpadding="2">
				    ...
				    <tr>
				        ...
				        <th class="list" width="140">Class Title</th>
						...
						<th class="list" width="60">&nbsp</th>
				   </tr>
